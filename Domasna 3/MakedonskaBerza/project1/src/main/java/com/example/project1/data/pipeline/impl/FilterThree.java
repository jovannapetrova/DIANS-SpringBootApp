...
public class FilterThree implements Filter<List<StockEntity>> {
    ...
    public FilterThree(StockRepository stockRepository, StockRecordRepository stockRecordRepository) {
